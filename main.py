...
'''Обозначения:
    ...
    После гласной (или ударения) можно ставить знак акцента @ для ручной расстановки акцнтов, но тогда надо в строке
    расставлять все акценты.
'''
...
и сме'рть претерпе'ти, / и воскреси'ти уме'ршия // сла'вным воскресе'@ние@м Свои'м.

"""# Поставим акцент на яко.
...
text7 = """Разру́шил еси́ Кресто́@м Твои́м сме́рть, /
...
textTestSaveSymbols = """
Погребе'ние Твое', Го'@споди, / у'зы а@'довы сокруши'вшее растерза', /
 е'же из ме'ртвых' воскресе'нием мi'р@ п@росвети', // Го'споди сла@'ва@ Тебе'.
""" # Лишний апостроф в 'мертвых' оставлен для того, чтобы проверить, что он сохранится в выходном тексте
# Аналогично знак акцента в 'просвети'
