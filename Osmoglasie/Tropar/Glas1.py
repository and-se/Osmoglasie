...
class Glas1_Template(GlasTemplateBase):
    ...
    def Markup_1(self, tree):
        ...
        elif len(betweenStressed) in list(range(2)) and accents.firstAccent != accents.lastAccent:
